...
def main():
    ...
    layout = [
        ...
        [sg.Text('Provider:', size=(15, 1)), 
         sg.Combo(['openai', 'azure', 'local'], default_value='openai', key='provider', size=(20, 1))],
        ...
        [sg.Text('Temperature:', size=(15, 1)), 
         sg.Slider(range=(0.0, 1.0), default_value=0.3, resolution=0.1, 
                   orientation='h', key='temperature', size=(30, 15))],
